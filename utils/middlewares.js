...
const LoginFailOpts = {
  ...
  points: 10, // Number of attempts allowed
    ...
    .catch((rateLimiterRes) => {
      if (
        ...
        res.setHeader("Retry-After", rateLimiterRes.msBeforeNext / 1000),
          ...
          res
            .status(429)
            .send("Too many authentication attemps. Please wait 5 minutes.");
        return;
      }
    });
};
...
const IpRequestOpts = {
  ...
  points: 120, // Number of attempts allowed
  duration: 60, // Per sec
  blockDuration: 60 * 5, // Block for 2 minutes
};
    ...
    .catch((rateLimiterRes) => {
      if (
        ...
        res.setHeader("Retry-After", rateLimiterRes.msBeforeNext / 1000),
          ...
          res.status(429).send("Too many requests from the same IP. Please wait 5 minutes");
        return;
      }
    });
};
